...
Route::group(['prefix' => 'user', 'middleware' => 'auth'], function () {
    ...
    Route::get('create', [UserController::class, 'create'])->name('user.create')->middleware('check.permission:add_user');
    Route::post('store', [UserController::class, 'store'])->name('user.store')->middleware('check.permission:add_user');
    Route::get('{user}/edit', [UserController::class, 'edit'])->name('user.edit')->middleware('check.permission:edit_user');
    Route::post('{user}/update', [UserController::class, 'update'])->name('user.update')->middleware('check.permission:edit_user');
    Route::get('{user}/delete', [UserController::class, 'destroy'])->name('user.destroy')->middleware('check.permission:delete_user');
});
